...
class Document:
    ...
    def __init__(self, content: str, source: str, header_title: str):
...
if __name__ == "__main__":
    d = Document("hello", "test.md", "Introduction")
    print(d.content, d.source, d.header_title)
    
    try:
        bad = Document("", "test.md", "Introduction")
